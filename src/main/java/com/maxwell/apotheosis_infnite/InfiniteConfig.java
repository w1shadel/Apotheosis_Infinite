...
public class InfiniteConfig {
    ...
    static {
        ...
        MAX_AFFIX_LEVEL = BUILDER.comment(
                        ...
                        "Increasing this value allows affixes to be upgraded beyond their limits, resulting in exponentially higher stats.")
        ...
        ENABLE_ALL_ITEMS_REFORGE = BUILDER.comment("If true, items that do not naturally support Apotheosis affixes (including items from other mods) will be eligible for reforging.")
        ...
        MAX_ENCHANTMENT_LEVEL = BUILDER.comment(
                        "The global maximum level for all enchantments.",
                        "WARNING: Setting this value higher than 255 may exceed the NBT data limit (Byte/Short),",
                        "potentially causing level overflows (resetting to 0), visual glitches, or game crashes.")
                .defineInRange("max_enchantment_level", 100, 1, Integer.MAX_VALUE);

        BUILDER.push("Jokes");

        ENABLE_WORLD_DESTRUCTION = BUILDER.comment(
                        "CRITICAL WARNING: If enabled, dying while holding an item with a Curse of Vanishing level of 100 or higher will PERMANENTLY DELETE THE WORLD.",
        ...
        ALLOW_HIGH_LEVEL_CURSES = BUILDER.comment(
                        ...
                        "If false, Curses will be locked to level 1 to minimize their negative impact while allowing other enchantments to scale infinitely.")
